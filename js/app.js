class Game {
    constructor(){
        ...
        this.seconds = 100;
        this.flips = 1;
        this.bgmusic = new Audio('./sounds/Run-Amok.mp3');
        this.clickaudio = new Audio('./sounds/video-game-mystery-alert.wav');
        this.startaudio = new Audio('./sounds/mixkit-game-click-1114 (1).wav');
        this.mathchsound = new Audio('./sounds/mixkit-arcade-mechanical-bling-210.wav');
        this.gamoversound = new Audio('./sounds/mixkit-sad-game-over-trombone-471.wav');
        this.winsound = new Audio('./sounds/mixkit-animated-small-group-applause-523.wav');
